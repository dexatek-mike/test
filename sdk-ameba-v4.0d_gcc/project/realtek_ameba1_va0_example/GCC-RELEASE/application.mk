...
# -------------------------------------------------------------------
ARM_GCC_TOOLCHAIN = $(GCC_CROSS_COMP)
AMEBA_TOOLDIR	= $(IAR_UTILITY)
FLASH_TOOLDIR = $(GCC_UTILITY)
...
# moved to DxFramework/kernel/console
SRC_C += ../../../component/soc/realtek/8195a/misc/driver/low_level_io.c
endif
...
INCLUDES += $(DEXATEK_INCLUDES)
SRC_C += $(DEXATEK_SRC_C)
DRAM_C += $(DEXATEK_DRAM_C)
endif
...
ifeq ($(NATIVE_BUILD),y)
CFLAGS += -DCONFIG_NATIVE_BUILD
else
CFLAGS += $(DEXATEK_CFLAGS)
endif
...
LIBFLAGS =
all: LIBFLAGS += -L../../../component/soc/realtek/8195a/misc/bsp/lib/common/GCC/ -l_platform -l_wlan -l_eap -l_http -l_dct -l_p2p -l_wps -l_rtlstd -l_usbd -l_sdcard -l_websocket -l_xmodem -l_codec -lm -lc -lnosys -lgcc
mp: LIBFLAGS += -L../../../component/soc/realtek/8195a/misc/bsp/lib/common/GCC/ -l_platform -l_wlan_mp -l_p2p -l_wps -l_rtlstd -l_dct -l_websocket -l_xmodem -l_codec -lm -lc -lnosys -lgcc
