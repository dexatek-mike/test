...
#else
//NOTE: This is short term solution only, to resolve 16 device information download which will exceed 4KB... 
//      We will need to start breaking the information download for get peripheral and container.
#pragma message ( "NOTE!!!: We change the ssl max buffer to 16KB (Short Term Solution ONLY)" )
